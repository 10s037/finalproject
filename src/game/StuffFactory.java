...
public class StuffFactory {
	...
	private void bloodToMana(Item item){
    ...
    //helper method for bats
	private void summonBats(Item item){
    ...
    //helper method for bats
    private void detectCreatures(Item item){
